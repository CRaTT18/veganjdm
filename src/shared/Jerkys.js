export const JERKYS = [
    ...
    },
    {
        ...
        total: "23",
        construction: "Fruit",
        notes: "This stuff is awesome. I thought there was no way this could classify as a jerky when I first picked it up. But they've pulled it off. It appears they've just taken fruit and pressed it in to a stick form. The moisture level is perfect, not too dry like fruit leather, but just right to give it a jerky quality. The texture and chew is a liitle soft as you would expect from a fruit based product. The pineapple and mango flavors are all delicious. The banana and pecan reminded me of banana bread and I wasn't that impresed by the other banana flavors but I'm not really in to bananas. I call these flavors, but the cool thing about this product is its just compressed fruit and some spices or nuts. You can buy it at the gas station and feel good about eating it. I ordered a sample pack on Amazon to get the Pineapple Chili & Salt as I could not find it in stores. It reminds me of a spicy pineapple margarita, which gives me an idea. I'm gonna have to put one of these in a glass of vodka and see what happens."
    },
    {
        id: 3,
