    ...
    <div className="container">
      <div className="row">
        <div className="col">
          ...
          <img src={forealVlouisville} className="m-3 img-fluid" alt="Lousville and Foreal Jerky Packages" /><img src={forealVlouisvilletexture} className="m-3 img-fluid" alt="Lousville and Foreal Jerky Pieces"/>
