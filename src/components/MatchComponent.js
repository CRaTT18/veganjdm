    ...
    <div className="container">
      <div className="row">
        <div className="col">
          ...
          <img src={forealVlouisville} className="m-4" alt="Lousville and Foreal Jerky Packages" /><img src={forealVlouisvilletexture} className="m-4" alt="Lousville and Foreal Jerky Pieces"/>
